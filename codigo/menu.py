...
def mostrar_menu(es_admin):
    ...
    print("7. Agregar mantenimiento")
    print("8. Eliminar mantenimiento")
    print("9. Modificar mantenimiento")
    print("10. Modificar insumo")

    if es_admin:
        print("11. Agregar proveedor")
        print("12. Eliminar proveedor")
        print("13. Agregar técnico")
        print("14. Eliminar técnico")
        print("15. Agregar máquina")
        print("16. Eliminar máquina")
        print("17. Modificar proveedor")
        print("18. Modificar técnico")
        print("19. Modificar máquina")
